...
Exception클래스는 모든 예외를 catch할 수 있으므로 반드시
마지막 블럭에 사용해야한다.
 */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i <= array.length; i++) {
                 ...
                 * 입력히면 정수로 변경할 수 없어 예외가 발생한다.
                 */
                array[i] = Integer.parseInt(scanner.nextLine());
            }

            /*
             * 1번인덕스에 0을 입력하면 연산이 불가능하므로 예외가 발생한다.
             */
            ...
            /*
             * 배열의 크기가 3이므로 인덱스는 2까지만 존재한다. 따라서 인덱스
             * 관련 예외가 발생한다.
             */
            array[3] = age;
        }
             ...
             * 마지막에 기술해야한다. 위쪽으로 이동시키면 에러가 발생한다.
        ...
        /*
         * 앞에서 예외가 발생하더라도 예외처리를 했으므로 프로그램은 마지막까지
         * 실행된 후 정상적으로 종료된다. 즉 실행의 흐릠이 마지막까지 이어지게
         * 하는 것이 "예외처리"의 목적이다.
         */
