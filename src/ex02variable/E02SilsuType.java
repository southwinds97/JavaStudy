...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		/*
		 실수자료형
		 -정수형보다는 실수형이 더 큰 자료형이다 . 0과 1사이에 무한히 많은 실수가
		 존재하기 때문이다.
...
//		300.0의 결과가 출력된다.
		...
		System.out.println("계산후 형반환="+ result3);
		
		/*
		 -실수형의 기본은 double이다.
		 -소수점이 있는 데이터를 컴파일러는 무조건 double로 인식한다.
		 -단, 소수점이 없는 데이터를 float에 대입하려면 접미사 F 혹은 f를 
		 붙여야한다.
...
//		float형 끼리의 연산은 기본규칙을 따르므로 float가 된다.
		float f6 = f3 + f4;
		
		System.out.println("f6="+ f6);
		
//		float와 double의 연산은 큰 자료형인 double로 반환된다.
		double d1 = 3.14;
		double d2 = f6 + d1;
