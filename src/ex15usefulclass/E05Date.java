...
public class E05Date {
     ...
     * 전달된 날짜서식으로 변경한 String을 반환한다.
     */
    public static String myDateFormat(Calendar c, String formatStr) {
        /*
         * getTime() :서버의 표준시인 1970-01-01 부터 현재까지의
         * 시간을 초 단위로 반환해준다. 이를 '타임스탬프'라고 한다.
         */
        Date date = c.getTime();
    ...
    public static void main(String[] args) {
         ...
         * 생성할 수 없고, 유틸리티 메서드를 통해 참조값을 얻어와야 한다.
         */
        Calendar calendar = Calendar.getInstance();

        /*
         * 월을 표현하는 Month, 분을 표현하는 Minute의 이니셜이 동일하므로
        ...
        /*
         * 올해 크리스마스까지 남은 날짜를 계산한다. 여기서는 두가지
         * 서식의 날짜를 파싱하여 구한 날짜인스턴스를 통해 계산한다.
         */
        // 오늘날짜 : 0000-00-00 형식
    ...
    public static long myDiffDate(String today, String future) {
        ...
        try {
            /*
             * 매개변수를 통해 전돨된 2개의 문자열은 날짜의 서식이 서로 다르다
             ...
             * 순수한 초(Sec)이고, 11~13자리까지는 밀리세컨드(MilliSec)를 의미한다.
             * 즉 100으로 나눠서 뒤의 3자리를 제거하면 순수한 '초'가 반환된다.
