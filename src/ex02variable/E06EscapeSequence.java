...
public class E06EscapeSequence {
	...
	public static void main(String[] args) {
		...
		/*
		 * 같은 출력 문장이지만 println()을 사용하면 아래와 같이 문자열과 변수를 분리하여 작성행하므로 조금 더 복잡하다.
		 */
		System.out.println("\n국어:" + kor + ", 영어:" + eng + ", 수학:" + math);

		/*
		 * 실수는 %f를 사용한다. 또한 정수와 시룻의 연산이므로 결과는 실수가 반환되어 double 타입의 변수에 대입해야 한다.
		 */
		double avg = (kor + eng + math) / 3.0;
		System.out.printf("평균점수:%f%n", avg);

		/*
		 * 자리수 지정하기 %4d: 정수 출력 시 4칸을 확보한 후 표현한다. %6.2f: 실수 출력 시 전체자리수는 6자리, 소수이하 2자리로
		 * 표현한다. 또한 양수는 우측, 음수는 좌측정렬된다.
		 */
