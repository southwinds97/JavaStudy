...
// 실행하는 형태를 가진다.
//  : switch문에서는 조건문을 사용하지 없고 산술식 혹은 정수식을 사용해야한다.

public class E02Switch {

    public static void main(String[] args) {

        // Scaaenr클래스 : 사용자로부터 입력 값을 받기위한 클래스로 해당 클래스의 메서드가
        // 실행되면 잠깐 실행이 중지되고 입력을 기다린다.
        // 보통 문자열이나 정수를 입력받기 위해 사용한다.
        Scanner scanner = new Scanner(System.in);
        System.out.print("숫자를 입력하세요: ");
        // nextInt()는 정수를 입력받기 위한 메서드로 문자를 입력하면
        ...
        // -byte, short, int, char, String타입만 사용 가능하다.
