...
public class E01WrapperClass2 {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 문자열을 숫자로 변경할 때는 반드시 숫자형식만 기술해야한다.
         ...
         * Character클래스의 주요메소드
         * 
         * codePointAt() : 문자열에서 특정 index에 해당하는 문자의
         * 아스키코드값을 반환한다.
         */
        ...
        /*
         * isWhitespace() : 공백문자인지 판단하는 메서드. 공백문자일 때
         * true를 반환한다.
         */
        ...
        for (int i = 0; i < chArr.length; i++) {
            // i번째 문자가 공백이라면 true를 반환
            if (Character.isWhitespace(chArr[i])) {
                // 공백문자가 확인되면 1증가
                whiteCnt++;
            }
        }
        System.out.println("공백의 갯수= " + whiteCnt);
    }
}
