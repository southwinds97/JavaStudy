...
/*
상속(Inheritance)
  : 기존에 정의된 클래스에 메서드와 변수를 추가하여 새로운 클래스를 정의하는것을
  말한다. 부모클래스를 자식클래스가 상속할때는 extends 키워드를 사용한다.
 */
...
class Man {
  ...
  /*
  멤버 메서드에서는 private 멤버라도 동일 클래스 내부이므로 접근이 가능하다.
  */
...
class BusinessMan extends Man {
  ...
  호출한다. 만약 super()를 기술하지 않으면 컴파일러에 의해 자동으로
  삽입되어 디폴트 생성자가 호출된다.
   */
  ...
  public void tellYourInfo() {
    ...
    자식클래스에서도 접근이 불가능하다. private은 무조건 자신의 클래스 내에서만
    접근이 가능하다.
     */
