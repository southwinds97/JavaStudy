...
public class Ex08AsList {
    ...
    public static void listPrint(String title, java.util.List<String> list) {
        // 타이틀 출력
    ...
    public static void main(String[] args) {
         ...
         * 초기데이터를 통해 크기를 유추할 수 잇으므로 크기는 선언문장에서
         * 생략해야한다.
         */
        String[] strArr = new String[] { "마린", "파이어뱃", "메딕", "마린" };
        /*
         * Arrays.asList() : 일반 배열을 List<T> 컬렉션으로 변경할 때
         * 사용한다. 단, 값을 참조만 할 수 있고 입력이나 삭제는 불가능하다.
         */
        List<String> list = Arrays.asList(strArr);
        listPrint("출력1", list);
        // 현 상태에서는 데이터를 추가할 수 없다. 런타임 에러 발생
        // list.add("탱크") //에러발생
