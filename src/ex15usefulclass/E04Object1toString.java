...
toString()메서드
-object에 정의된 메서드로 print()문이 문자열을 출력하기전에 자동으로 호출한다.
-인스턴스 변수를 문자열 형태로 변환하여 반환한다.
-필요한 경우 클래스 정의시 적절히 오버라이딩하여 재정의하는 것이 좋다.
단, 필수사항은 아니다.
 */

/*
해당 클래스는 toString()메서드를 오버라이딩하여 멤버변수를 반환하도록
정의하였다.
 */
