...
class FruitSeller3 {
     ...
     * 멤버메서드에서는 초기화 할 수 없다. 또한 초기값이 없는 상태로 선언 자체가
     * 불가능하다.
     * 하지만 생성자는 인스턴스 생성시 딱 한번만 호출되고, 개발자가 마음대로
     * 호출할 수 없으므로 한번 이상 초기화 되지 않음이 문법적으로 보장된다.
    ...
    public FruitSeller3(int money, int appleNum, int price) {
        myMoney = money;
        numOfApple = appleNum;
        // 이 부분을 삭제하면 에러가 발생한다. 상수는 선언과 동시에 초기화해야 한다.
        APPLE_PRICE = price;
    }
...
public class E06FruitSalesMain3 {
    ...
    public static void main(String[] args) {
         ...
         * 할 수 있다. 따라서 초기화 메서드를 사용하는 것보다 간단한 코드로
         * 작성할 수 있는 장점이 있다.
         */
