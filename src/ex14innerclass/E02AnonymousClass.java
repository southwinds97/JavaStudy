...
class Singer {
     ...
     * 반환해준다. Java에서 정의하는 모든 클래스는 Object클래스를
...
class GirlGroup extends Singer {
    ...
    // 부모의 toSrting()을 호출하기 위해 super를 사용한다
    @Override
    public String toString() {
        // 이름과 팀명을 반환
...
public class E02AnonymousClass {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 인스턴스의 참조값을 할당받은 참조변수를 출력한다. 이 때 오버라이딩한
