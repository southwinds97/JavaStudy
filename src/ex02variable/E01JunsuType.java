...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		// -일반적으로 CPU(중아엋리장치)는 정수형 연산을 할때 int형을 가장
		// 빠르게 처리한다.
		...
		// 100/200의 결과는 0이 나오게된다. Java에서는 정수와 정수의
		// 연산결과로 정수가 반환된다. 만약 실수의 결과를 반환받고 싶다면
		// 형변환(Type Casting)을 해야한다.
		result1 = int1 / int2;
		System.out.println("int1 / int2 = " + result1);

		// -동일한 타입의 변수를 2개이상 선언할 떄는 컴마를 사용할 수 있다
		// -int형보다 작은 자료형을 연산하면 CPU는 int형으로 변환하여 계산한다.
		// -CPU는 정수의 연산인 경우 int형에 최적화 되어있기 떄문이다.
		// -byte, short형은 게임캐릭터의 움직임이나 음원파일 등을 표현할 떄 주로 사용한다.
		...
		// -동일 자료형끼리의 연산은 동일자료형이 되는 것이 기본 원칙이다.
		// -하지만 큰 자료형과 작은 자료형을 연산하면 큰 자료형으로 자동 형 변환된다.
		// 이유는 데이터 의 손실(오차)이 있을 수 있기 떄문이다.
		...
		// 이때 접미사(L 혹은 l)을 붙여서 itn형 자료가 아닌 long형의 자료임을
		// 컴파일러에게 알려줘야한다. 이와같이 할당을 위해 입력되는 숫자도 자료형을
