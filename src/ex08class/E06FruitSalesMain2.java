 ...
 * 추가한다. 초기값이 미리 지정되어 있는 것은 인스턴스 생성시 확장성이 떨어진다.
 */
...
class FruitSeller2 {
     ...
     * 즉 초기값이 없는 상태로는 선언 상태가 불가능하다. 따라서 두번째 예제에서는
     * 기존의 상수를 일반 변수로 변경해야한다.
     */

    /*
     * 초기화 메서드를 선언하여 객체(인스턴스) 생성 후 다양한 형태의 초기화가 가능하다.
     */
