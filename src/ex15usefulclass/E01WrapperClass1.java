...
/*
Wrapper class: 기본자료형의 데이터를 인스턴스화 할 때 사용하는 클래스로
...
public class E01WrapperClass1 {
    ...
    public static void main(String[] args) {
        ...
        /*
         * JDK 1.4 이전 버전에서의 코딩형식
         * 기본자료형을 박싱처리한 인스턴스에 대해 산술연산을 진행할떄
         * 언박싱의 위해 intValue()와 같은 메소드를 호출해야한다.
         */
        ...
        /*
         * JDK 1.5 이후 버전에서의 코딩형태
         * 오토박싱 혹은 오토언박싱이 지원되므로 기본자료형 변수를 사용하는 것과
         * 동일하게 코딩할 수 있다.
         */
