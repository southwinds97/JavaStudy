...
public class Ex05ParamNReturn {
    ...
    public static void main(String[] args) {
         ...
         * 람다식에서는 생략할 수 있다. 메서드명을 제거한 후 괄호사이에
         * 화살표를 삽입하여 람다식을 정의한다. 호출시에는 인터페이스에 정의된
         * 추상메서드를 이용하면 된다.
         */
        StringConcat sc = (a, b) -> {
        ...
        /*
         * 매개변수가 둘다 없는 람다식을 정의해야하므로 빈 소괄호를 사용한다.
        ...
        String[][] resultStr = gugudanRange.guguString(4, 6);
        // 반환된 결과값을 통해 4단에서 6단까지 출력한다.
        for (int i = 4; i <= 6; i++) {
            for (int j = 1; j <= 9; j++) {
                System.out.print(resultStr[i - 1][j - 1] + "  ");
            }
            System.out.println();
        }
