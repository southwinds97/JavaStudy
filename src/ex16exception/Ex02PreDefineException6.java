...
public class Ex02PreDefineException6 {
  ...
  public static void main(String[] args) {
     ...
     * 전혀 없는 상태이므로 이 상태에서는 형반환을 할 수 없어 예외가 발생한다.
     */
  ...
  /*
   * String 인스턴스가 인수로 전달되면서 매개변수를 통해 Object로 자동형변환
   * 되므로 여기에서 상속관계가 확인된다. o는 원래 String타입이었으므로
   * instancof 연산자를 통해 String임을 확인할 수 있고 이 경우에는
   * 다운캐스팅(명시적형변환)이 가능하게 된다.
   */
