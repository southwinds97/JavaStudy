...
/*
 * 해당 예제에서는 Human클래스를 별도의 파일로 작성하였따. 동일한 패키지에
 * 정의되었다면 컴파일러는 해당 클래스를 찾아 즉시 객체(인스턴스)화 할 수 있다.
...
public class E02HumanMain {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 1.클래스를 통해 객체(인스턴스)를 생성한다. 참조변수(인스턴스형 변수)는
        ...
        human.walking();
        human.thinking();
        human.showState(); // 메서드 호출 후 상태 확인
