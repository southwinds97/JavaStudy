...
class Speaker {
  ...
  /*
  멤버변수가 private이므로 외부에서 값을 설정할 수 있도록 정의한
  setter 메서드 
  */
...
class BaseSpeaker extends Speaker {
  ...
  public void showState() {
	  ...
	  특히 오버라이딩 된 메서드를 호출할떄 super가 없으면 재귀호출이
	  되므로 주의해야한다
	   */
    super.showState();
...
public class E06Overriding {
  public static void main(String[] args) {
    ...
    /*
    단 부모타입의 변수로 자식 인스턴스를 참조하면 접근할수 있는
    범위가 부모인스턴스까지로 제한되므로, 자식쪽에 정의된 메서드는
    호출할 수 없다.
     */
