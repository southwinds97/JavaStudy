...
public class E02StringMethod3 {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 11] lastIndexOf() : 사용법은 indexOf()와 동일하나 문자열의 뒤에서부터 찾는다. 파일의 확장자를 찾아야 하는
         * 업무에서는 뒤에서부터 찾는 것이 유리할 수 있다.
         */
        ...
        /*
         * 12] replace() : 특정 문자를 찾아서 지정된 문자로 변경한다. 찾는 문자열이 없다고 하더라도 에러가 발생하지는 않는다.
         */
        ...
        /*
         * 13] split() : 문자열을 구분자로 통해 분리해서 String타입의 배열로 반환한다. 해당 구분자가 없는 경우에는
         * 크기가 1인 배열로 반환된다.
         */
        System.out.println("### 13 ###");
        String phoneNumber = "010-1234-5678";
        // 전화번호를 -(하이픈)을 구분자로 분리하여 크기가 3인 배열로 반환
        String[] phoneArr = phoneNumber.split("-");
        // 배열의 크기만큼 반복하면서 요소를 출력
        for (int i = 0; i < phoneArr.length; i++) {
            System.out.printf("phoneArr[%d]=%s\n", i, phoneArr[i]);
        }
        /*
         * 구분자로 사용한 문자열이 없는 경우 문자열 전체가 통쨰로 반환되어
         * 크기가 1인 배열이 생성된다.
         */
        ...
        /*
         * 14] substring() : 시작인덱스와 끝인덱스 사이의 문자열을 잘라서 반환해준다.
         * 방법 1 : 인덕스 하나만 사용 => 사용한 인덱스부터 끝까지 잘라서 반환한다.
         * 방법 2 : 인덱스 두개 사용 => 시작, 종료 인덱스가 되므로 해당 구간의 문자열을 잘라서 반환한다.
         */
