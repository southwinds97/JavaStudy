...
/*
이와 같이 추상클래스를 아래에 잇는 인터페이스로 변경할 수 있다.
...
/*
 * 추상메서드를 포함한 인터페이스를 구현하면 하위 클래스에서는 반드시 오버라이딩을 해야 한다.
 * 추상메서드를 포함한 클래스는 반드시 abstract로 선언하거나, 그렇지 않으면 오버라이딩을 통해
 * 부모 인터페이스의 추상메서드를 재정의해야 한다.
 */
...
public class Ex01NormalClass {
  ...
  public static void main(String[] args) {
     ...
     * 
     * 여기서는 부모타입의 참조변수를 통해 인스턴스를 생성한 후 오버라이딩된
     * 자식쪽의 메서드를 호출하고 있다.
     */
