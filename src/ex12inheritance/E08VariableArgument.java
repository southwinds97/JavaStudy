 ...
 * : 메서드 오버로딩을 대처할 수 있는 문법으로 하나의 메서드로 여러가지
 * 호출형식을 대체할 수 있다.
 * 형식]
 * 메서드명(자료형 ... 매개변수명) {
 *    실행문장;
...
public class E08VariableArgument {
     ...
     * 또한 메서드 내에서는 배열로 반환되어 "매개변수명.length"와 같이 코딩할 수 있다.
     */
    static int getTotal(int... param) {
        int total = 0;
        // 전달된 인수의 크기만큼 반보갛여 누적해서 더한다.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("getTotal(args2) 호출:" + getTotal(10, 20));
        System.out.println("getTotal(args3) 호출:" + getTotal(10, 20, 30));
        System.out.println("getTotal(매개변수6) 호출:" + getTotal(10, 20, 30, 40, 50, 60));
        /*
         * 매개변수의 타입이 double이 포함되어 있으므로 호출이 불가능하다.
         * 만약 아래와 같이 실수를 모두 처리할려면 가변인자를 double로 선언해야 한다.
         */
