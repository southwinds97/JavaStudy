...
-인스턴스가 순서없이 저장된다.
-인스턴스의 중복저장을 기본적으로 허용하지 않는다.
-기본클래스(String, Integer, ...)인 경우 별도의 처리없이 중복이 제거된다.
-개발자가 정의한 클래스라면 hashCode, equals메서드를 적절히 오버라이딩 해야만 중복을 제거할 수 있다.
...
public class Ex04HashSet1 {
    ...
    public static void main(String[] args) {
        /*
         * Object를 기반으로 한 set컬렉션을 생성했으므로 모든
         * 인스턴스를 저장할 수 있다.
         */
        ...
        // size()를 통해 저장된 인스턴스의 갯수를 출력 : 5개 출력됨
        System.out.println("[중복 저장전 객체수]: " + set.size());
        /*
         * 기본클래스의 인스턴스 중복저장
         * : 기본클래스의 경우 별도의 오버라이딩 없이도 중복이 제거된다.
        ...
        /*
         * 이터레이터를 통한 인스턴스 출력 : 순서없이 저장되므로 출력의 순서도
         * 정할 수 없다.
         */
        // 1.set 참조변수를 통해 Iterator인스턴스를 생성
        ...
        while (itr.hasNext()) {
             ...
             * 확인한 후 다운캐스팅하여 출력한다.
             * 만약 다운캐스팅을 하지않으면 자식멤버에 접근할 수 없으므로 getName()을
             * 호출할 수 없다.
             */
