...
class MyClass {
     ...
     * 동일여부를 판단한다. equals() 메소드의 매개변수 타입은 모든
    ...
    public boolean equals(Object obj) {
         ...
         * 되므로 다운캐스팅 이후에 비교를 진행해야 한다.
         * 이때 전달된 인스턴스가 MyClass타입이 아니라면 비교의 대상이
         * 될 수 없으므로 상속관계 확인을 위해 instanceof 연산자를 사용한다.
         */
...
public class E04Object3Equals {
    ...
    public static void main(String[] args) {
         ...
         * 민액 오버라이딩 한 equals()를 삭제한 후 실행하면 다르다라는 결과가
         * 출력된다. 즉 오버라이딩이 필요없는 경우는 기본클래스일 때만 가능하다.
         */
        System.out.println("[두 객체의 equals() 메소드로 비교]");
        System.out.println(mc1.equals(mc2) ? "같다" : "다르다");

        /*
         * print()를 통해 출력하면 자동으러 toString() 호출하므로
         * 아래 출력결과는 동일하다.
         */
